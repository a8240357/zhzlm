    ...
    <div class="layui-tab-content">
       <form class="layui-form">
        <div class="layui-tab-item layui-show">
          ...
          <?php echo Form::input('text','author','','作者', '', '请输入作者','required');?>
          <?php echo Form::file('image_url','','图片','','','images','','图片','image');?>
          <?php // echo Form::radio('is_recommend',0,'是否推荐','用于首页推荐展示',array(1=>'是',0=>'否'));?>
          <?php echo Form::radio('is_theme',0,'是否为主题文章','用于主题页面展示',array(1=>'是',0=>'否'));?>
          <?php echo Form::radio('is_use',1,'是否启用','用于控制文章是否显示',array(1=>'是',0=>'否'));?>
