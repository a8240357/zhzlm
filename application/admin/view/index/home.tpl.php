    ...
    <div class="layui-tab-content index_panel_container">
        <div class="left">
            <blockquote class="layui-elem-quote">
                <p>系统版本：ZHZLM <?php echo ZHZ_VERSION; ?></p><hr>
            ...
            <blockquote class="layui-elem-quote">
                <p>系统名称：照护者联盟</p><hr>
                <p>开发作者：老张</p><hr>
                <p>项目官网： <a target="_blank" href="http://zhzlm.wukehui.cn">http://zhzlm.wukehui.cn</a></p><hr>
                ...
                <p>BUG反馈： <a target="_blank" href="http://www.testlzcms.com/index/feedback.html">http://www.testlzcms.com/index/feedback.html</a></p>
            </blockquote>
        </div>
        <div class="right">
