...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree left_menu_ul content_put_manage hide">
              ...
              <!-- <li class="layui-nav-item content_manage">  原来的   带栏目搜索页的
                <a href="<?php // echo url('category/content_manage_search') ?>" target="main">
                  <i class="layui-icon">&#xe60a;</i>
                  <cite>内容管理</cite>
                </a>
              </li> -->
              <li class="layui-nav-item content_manage"><!--  改完之后的  （不要栏目搜索页的）-->
                <a href="<?php echo url('article/index') ?>" target="main">
                  <i class="layui-icon">&#xe60a;</i>
                  <cite>内容管理</cite>
                </a>
              </li>
              ...
              <!-- 轮播图管理 -->
              <li class="layui-nav-item">
                <a href="<?php echo url('banner/index') ?>" target="main">
                  <i class="layui-icon">&#xe64a;</i>
                  <cite>轮播图管理</cite>
                </a>
              </li>
    ...
    <div class="layui-footer footer">
      <div class="layui-main">
        <p>2019 © <a target="_blank" href="http://zhzlm.wukehui.cn">ZHZLM</a></p>
      </div>
    </div>
</div>
