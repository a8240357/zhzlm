          ...
          <div class="layui-tab layui-tab-card">
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                ...
                <?php // echo Form::radio('is_cover',1,'是否显示封面','无封面则进入下级第一个栏目列表页',array(1=>'是',0=>'否'));?>
                <?php // echo Form::radio('is_use',1,'是否启用','',array(1=>'是',0=>'否'));?>
                <?php // echo Form::radio('is_recommend',1,'是否推荐','',array(1=>'是',0=>'否'));?>
